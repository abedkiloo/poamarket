        ...
        <div class="container">
            <div class="d-sm-flex justify-content-between">
                        ...
                        <li>
                            <div class="language-selector">
                                ...
                                <select name="language" class="selectpicker">
                                    ...
                                    <option
                                            value="{{route('front.language',$language->id)}}" {{ Session::has(
                                    'language') ? ( Session::get('language') == $language->id ? 'selected' : '' ) :
                        ...
                        <li>
                            <div class="currency-selector">
                                ...
                                <select name="currency" class="selectpicker">
                                    ...
                                    <option value="{{route('front.currency',$currency->id)}}" {{ Session::has(
                                    'currency') ? ( Session::get('currency') == $currency->id ? 'selected' : '' ) :
                ...
                <div class="header-top-right-blk">
                    ...
                    <ul>
                        <li title="{{ $langg->lang10 }}"><a href="{{ route('product.compare') }}" data-toggle="tooltip">
                        ...
                        <li><a href=""><span class="fa fa-shopping-cart"
                                             id="cart-count">{{ Session::has('cart') ? count(Session::get('cart')->items) : '0'
                                }}</span>
                            </a></li>
                        <li>
                            <a href=""><i class="fal fa-unlock-alt"></i>Login</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <a href="{{route('front.index')}}" class="site-lgoo"><img src="assets/img/site-logo.png" alt=""></a>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 col-lg-5">
                <div class="header-top-right-info">
                    <ul>
                        <li><a href=""><img src="assets/img/h-icon-1.png" alt="">Free call
                                us<span>(+234) 9876543210</span></a></li>
                        <li><a href=""><img src="assets/img/h-icon-2.png" alt="">Your cart<span>{{ Session::has('cart') ? count(Session::get('cart')->items) : '0'}} item(s)</span></a>
        ...
        <div class="site-menu-wrapper">
            <div class="d-flex justify-content-between site-main-menu-area">
                <div class="cat-wrapper">
                    <a href="#/" class="cat-btn"><i class="fas fa-bars"></i>Categories</a>
                </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-sm-6 mb-5 mb-sm-0 text-center text-sm-left">
                    ...
                    <ul class="site-footer__contact">
                        ...
                        <li><a href="mailto:info@yourdomain.com"><i class="fas fa-envelope"></i> Email:
                    ...
                    <div class="media align-items-center site-footer__news">
                        ...
                        <div class="media-body">
                            <h3><a href="#"> {{mb_strlen($blog->title,'utf-8') > 45 ?
                                    mb_substr($blog->title,0,45,'utf-8')."
                                    .." : $blog->title}}
                                </a></h3>
                            <ul class="source">
