              ...
              <table class="table">
                ...
                <thead>
                  <tr>
                    ...
                    <th>{{ $langg->lang125 }}</th>
                    <th>{{ $langg->lang126 }}</th>
                    <th><i class="far fa-times-square"></i></th>
                  </tr>
                </thead>
                <tbody>
                  @if(Session::has('cart'))
                    ...
                    <tr class="cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}">
                      ...
                      <td>
                        <span class="removecart cart-remove" data-class="cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}" data-href="{{ route('product.cart.remove',$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])) }}"><i class="fas fa-trash-alt"></i> </span>
                      </td>
                    </tr>
                    @endforeach
                  @endif
            ...
            <div class="order-box">
              <h4 class="title">{{ $langg->lang127 }}</h4>
                ...
                <div class="text-center">
                  <a href="{{ route('front.checkout') }}" class="popup-hero__btn">
                    {{ $langg->lang135 }}
                  </a>
                </div>
            </div>
